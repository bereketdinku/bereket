        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">bereketdinku@gmail.com</span>
            ...
            <div className="contact_card">
              <i className="bx bx-linkedln contact_card-icon"></i>
              <h3 className="contact_card-title">LinkedIn</h3>
              <span className="contact_card-data">
                https://www.linkedin.com/in/bereket-dinku-4a0332297/
              </span>
              <a href="" className="contact_button">
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">0901108024</span>
              <a href="" className="contact_button">
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              </a>
